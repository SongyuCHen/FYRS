	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;通讯录</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="txl_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="txl_list" class="main_list">
									<table class="dataTable" data-maxindex="${txlList.size()}">
										<thead>
										...
										<tbody>
											<c:forEach items="${txlList}" var="txlList"
													varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${txlList.CQh}</td>
														<td class="center">${txlList.CBgdh}</td>
														<td class="center">${txlList.CJtdh}</td>
														<td class="center">${txlList.CYddh}</td>
														<td class="center">${txlList.CYzbm}</td>
														<td class="center" data-keyid="${txlList.NId}" data-fydm="${txlList.NFy}" data-rybh="${txlList.NRybh}"> 
...
<div id="txl_dlg"></div><div class="J_dlg"></div>
</body>
</html>
