	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;学位信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="xwxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="xwxx_list" class="main_list">
									<table class="dataTable"  data-maxindex="${xwxxList.size()}">
										<thead>
										...
										<tbody>
											<c:forEach items="${xwxxList}" var="xwxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${xwxxList.NXw}</td>
														<td  class="center">${xwxxList.NSxzy}</td>
														<td class="center">${xwxxList.CXxmc}</td>
														<td class="center">${xwxxList.DByrq}</td>
														<td class="center">${xwxxList.NDqxx}</td>
														<td class="center" data-keyid="${xwxxList.NId}" data-fydm="${xwxxList.NFy}" data-rybh="${xwxxList.NRybh}"> 
...
<div id="xwxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
