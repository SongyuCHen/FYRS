	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;在读信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="zdxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="zdxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${zdxxList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">在读学历</th>
											<th>在读专业</th>
											<th>在读院校</th>
											<th width="90px">入学日期</th>
											<th>当前信息</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${zdxxList}" var="zdxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${zdxxList.NZdxl}</td>
														<td class="center">${zdxxList.CZdzy}</td>
														<td class="center">${zdxxList.CZdyx}</td>
														<td class="center">${zdxxList.DRxrq}</td>
														<td class="center">${zdxxList.NDqxx}</td>
														<td class="center" data-keyid="${zdxxList.NId}" data-fydm="${zdxxList.NFy}" data-rybh="${zdxxList.NRybh}"> 
...
<div id="zdxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
