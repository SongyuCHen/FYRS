	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;兼任职务</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="jrzw_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="jrzw_list" class="main_list">
									<table class="dataTable" data-maxindex="${jrzwList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">任免类型</th>
											<th>兼任职务</th>
											<th width="90px">任免日期</th>
											<th width="90px">批准日期</th>
											<th>当前信息</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${jrzwList}" var="jrzwList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${jrzwList.NRmlb}</td>
														<td class="center">${jrzwList.CJrzw}</td>
														<td class="center">${jrzwList.DRmrq}</td>
														<td class="center">${jrzwList.DPzrq}</td>
														<td class="center">${jrzwList.NDqxx}</td>
														<td class="center" data-keyid="${jrzwList.NId}" data-fydm="${jrzwList.NFy}" data-rybh="${jrzwList.NRybh}"> 
...
<div id="jrzw_dlg"></div><div class="J_dlg"></div>
</body>
</html>
