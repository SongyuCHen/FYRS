	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;数据变动信息&nbsp;&gt;休假信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="xjxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="xjxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${xjxxList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">开始时间</th>
											<th>结束时间</th>
											<th>休假天数</th>
											<th width="90px">休假类型</th>
											<th>休假事由</th>
											<th>操作</th>
										</thead>
										<tbody>
												<c:forEach items="${xjxxList}" var="xjxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${xjxxList.DKssj}</td>
														<td class="center">${xjxxList.DJssj}</td>
														<td class="center">${xjxxList.NXjts}</td>
														<td class="center">${xjxxList.NType}</td>
														<td class="center">${xjxxList.CXjsy}</td>
														<td class="center" data-keyid="${xjxxList.NId}" data-fydm="${xjxxList.NFy}" data-rybh="${xjxxList.NRybh}"> 
...
<div id="xjxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
