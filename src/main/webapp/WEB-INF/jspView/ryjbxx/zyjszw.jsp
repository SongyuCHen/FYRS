	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;专业技术职务</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="zyjszw_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
								<div id="zyjszw_list" class="main_list">
									<table class="dataTable" data-maxindex="${zyjszwVOList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th>取得名称</th>
											<th>取得途径</th>
											<th width="80px">取得日期</th>
											<th>聘任名称</th>
											<th width="80px">聘任日期</th>
											<th width="80px">职称等级</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${zyjszwVOList}" var="zyjszwVOList"
													varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${zyjszwVOList.NQdmc}</td>
														<td class="center">${zyjszwVOList.NQdtj}</td>
														<td class="center">${zyjszwVOList.DQdrq}</td>
														<td class="center">${zyjszwVOList.NPrmc}</td>
														<td class="center">${zyjszwVOList.DPrrq}</td>
														<td class="center">${zyjszwVOList.NZcdj}</td>
														<td class="center" data-keyid="${zyjszwVOList.NId}" data-fydm="${zyjszwVOList.NFy}" data-rybh="${zyjszwVOList.NRybh}"> 
...
<div id="zyjszw_dlg"></div><div class="J_dlg"></div>
</body>
</html>
