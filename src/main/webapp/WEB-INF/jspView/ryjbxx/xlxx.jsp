	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;学历信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="xlxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="xlxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${xlxxList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">学历</th>
											<th>所学专业</th>
											<th>学校名称</th>
											<th width="90px">毕业日期</th>
											<th>当前信息</th>
											<th>操作</th>
										</thead>
										<tbody>
												<c:forEach items="${xlxxList}" var="xlxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${xlxxList.NXl}</td>
														<td class="center">${xlxxList.NSxzy}</td>
														<td class="center">${xlxxList.CXxmc}</td>
														<td class="center">${xlxxList.DByrq}</td>
														<td class="center">${xlxxList.NDqxx}</td>
														<td class="center" data-keyid="${xlxxList.NId}" data-fydm="${xlxxList.NFy}" data-rybh="${xlxxList.NRybh}"> 
...
<div id="xlxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
