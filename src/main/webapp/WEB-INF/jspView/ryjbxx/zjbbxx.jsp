	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;数据变动信息&nbsp;&gt;职级变动信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="zjbbxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="zjbbxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${zjbgList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">批准文号</th>
											<th>变动时间</th>
											<th>变动前职级</th>
											<th width="90px">变动后职级</th>
											<th>备注</th>
											<th>操作</th>
										</thead>
										<tbody>
												<c:forEach items="${zjbgList}" var="zjbgList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${zjbgList.CPzwh}</td>
														<td class="center">${zjbgList.DBgsj}</td>
														<td class="center">${zjbgList.CZjbefore}</td>
														<td class="center">${zjbgList.CZjafter}</td>
														<td class="center">${zjbgList.CBz}</td>
														<td class="center" data-keyid="${zjbgList.NId}" data-fydm="${zjbgList.NFy}" data-rybh="${zjbgList.NRybh}"> 
...
<div id="zjbbxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
