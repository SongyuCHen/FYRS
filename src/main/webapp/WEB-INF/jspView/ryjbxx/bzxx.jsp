	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;备注信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="bzxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="bzxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${bzxxList.size()}">
										<thead>
										...
										<tbody>
											<c:forEach items="${bzxxList}" var="bzxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${bzxxList.CBz}</td>
														<td class="center" data-keyid="${bzxxList.NId}" data-fydm="${bzxxList.NFy}" data-rybh="${bzxxList.NRybh}"> 
...
<div id="bzxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
