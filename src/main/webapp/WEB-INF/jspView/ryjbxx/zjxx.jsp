	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;职级信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="zjxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button> 								    
								</div>
									<div id="zjxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${zjxxList.size()}">
										<thead>
										...
										<tbody>
											<c:forEach items="${zjxxList}" var="zjxxList" varStatus="i">
												<tr>
													<td class="center">${i.index+1}</td>
													<td class="center">${zjxxList.NRmlb}</td>
													<td class="center">${zjxxList.NZj}</td>
													<td class="center">${zjxxList.DRmrq}</td>
													<td class="center">${zjxxList.NDqxx}</td>
													<td class="center" data-keyid="${zjxxList.NId}" data-fydm="${zjxxList.NFy}" data-rybh="${zjxxList.NRybh}"> 
...
<div id="zjxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
