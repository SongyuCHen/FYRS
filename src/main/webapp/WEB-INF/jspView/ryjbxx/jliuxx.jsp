	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;交流信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="jliuxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="jiaolxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${jliuxxList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">交流类别</th>
											<th>交流方式</th>
											<th>交流职务性质</th>
										...
										<tbody>
											<c:forEach items="${jliuxxList}" var="jliuxxList"
													varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${jliuxxList.NJllb}</td>
														<td class="center">${jliuxxList.NJlfs}</td>
														<td class="center">${jliuxxList.NJlzwxz}</td>
														<td class="center">${jliuxxList.DKsrq}</td>
														<td class="center">${jliuxxList.DJsrq}</td>
														<td class="center" data-keyid="${jliuxxList.NId}" data-fydm="${jliuxxList.NFy}" data-rybh="${jliuxxList.NRybh}"> 
...
<div id="jliuxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
