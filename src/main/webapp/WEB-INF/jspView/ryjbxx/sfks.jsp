	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;司法考试</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="sfks_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="sfks_list" class="main_list">
									<table class="dataTable" data-maxindex="${sfksVOList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th>法律职业资格证书类型</th>
											<th width="80px">颁证日期</th>
											<th>证书编号</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${sfksVOList}" var="sfksVOList"
													varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${sfksVOList.NZslx}</td>
														<td class="center">${sfksVOList.DBzrq}</td>
														<td class="center">${sfksVOList.CZsbh}</td>
														<td class="center" data-keyid="${sfksVOList.NId}" data-fydm="${sfksVOList.NFy}" data-rybh="${sfksVOList.NRybh}"> 
...
<div id="sfks_dlg"></div><div class="J_dlg"></div>
</body>
</html>
