	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;惩处信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="ccxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="ccxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${ccxxList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">惩处类别</th>
											<th>惩处原因</th>
											<th width="80px">惩处日期</th>
											<th width="80px">解除日期</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${ccxxList}" var="ccxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${ccxxList.NCclb}</td>
														<td class="center">${ccxxList.NCcyy}</td>
														<td class="center">${ccxxList.DCcrq}</td>
														<td class="center">${ccxxList.DJcrq}</td>
														<td class="center" data-keyid="${ccxxList.NId}" data-fydm="${ccxxList.NFy}" data-rybh="${ccxxList.NRybh}"> 
...
<div id="ccxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
