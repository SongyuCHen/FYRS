...
<div class="wapper">
	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;声音与影像</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									<span>当前人员：桑晟</span><span style="left:180px;">单位：淮安市中级人民法院</span><span style="right:125px;">状态：在职</span>
									<input type="button" class="addNew_btn" id="syyyx_add_btn" data-btn_type="0" value="添加" />   
								</div>
									<div id="syyx_list" class="main_list">
									<table class="dataTable" data-maxindex="${syyyxList.size()}">
										<thead>
										...
										<tbody>
											<c:forEach items="${syyyxList}" var="syyyxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${syyyxList.CFilename}</td>
														<td class="center">${syyyxList.CMs}</td>
														<td class="center" data-bh="${syyyxList.NId}">
															<a class="dlg_view" data-btn_type="1">查看</a><span>|</span>
															<a class="dlg_modify" data-btn_type="2">修改</a><span>|</span>
															<a class="i_delete">删除</a>
														</td>
													</tr>
												</c:forEach>
										</tbody>
	...
	<div id="syyyx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
