	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;政治面貌</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									<span>当前人员：${cxm}</span><span>单位：${fymc}</span><span>状态：在职</span>
									<button type="button" class="btn btn-primary" id="zzmm_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button> 								    
								</div>
									<div id="zzmm_list" class="main_list">
									<table class="dataTable" data-maxindex="${zzmmList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th>政治面貌</th>
											<th width="90px">加入日期</th>
											<th width="90px">转正日期</th>
											<th>当前信息</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${zzmmList}" var="zzmmList" varStatus="i">
												<tr>
													<td class="center">${i.index+1}</td>
													<td class="center">${zzmmList.NZzmm}</td>
													<td class="center">${zzmmList.DJrrq}</td>
													<td class="center">${zzmmList.DZzrq}</td>
													<td class="center">${zzmmList.NDqxx}</td>
													<td class="center" data-keyid="${zzmmList.NId}" data-fydm="${zzmmList.NFy}" data-rybh="${zzmmList.NRybh}"> 
...
<div id="zzmm_dlg"></div><div class="J_dlg"></div>
</body>
</html>
