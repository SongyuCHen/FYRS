						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="rcxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
								<div id="rcxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${rcxxList.size()}">
										<thead>
											<th width="42px">序号</th>
											<th width="100px">部门</th>
											<th width="150px">人才类型</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${rcxxList}" var="rcxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${rcxxList.NBm}</td>
														<td class="center">${rcxxList.NRclx}</td>
														<td class="center" data-keyid="${rcxxList.NId}" data-fydm="${rcxxList.NFy}" data-rybh="${rcxxList.NRybh}"> 
...
<div id="rcxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>