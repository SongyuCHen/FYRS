...
<div class="wapper">
	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;家庭信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="jtxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="jtxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${jtxxList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">与本人关系</th>
											<th>姓名</th>
										...
										<tbody>
											<c:forEach items="${jtxxList}" var="jtxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${jtxxList.NYbrgx}</td>
														<td class="center">${jtxxList.CXm}</td>
														<td class="center">${jtxxList.DCsrq}</td>
														<td class="center">${jtxxList.NZzmm}</td>
														<td class="center" data-keyid="${jtxxList.NId}" data-fydm="${jtxxList.NFy}" data-rybh="${jtxxList.NRybh}"> 
	...
	<div id="jtxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
