	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;公务员级别</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="gwyjb_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="gwyjb_list" class="main_list">
									<table class="dataTable" data-maxindex="${gwyjbList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">公务员级别</th>
										...
										<tbody>
											<c:forEach items="${gwyjbList}" var="gwyjbList" varStatus="i">
											<tr>
												<td class="center">${i.index+1}</td>
												<td class="center">${gwyjbList.NGwyjb}</td>
												<td class="center">${gwyjbList.DQsrq}</td>
												<td class="center">${gwyjbList.CDw}</td>
												<td class="center">${gwyjbList.NGzdc}</td>
												<td class="center">${gwyjbList.NDqxx}</td>
												<td class="center" data-keyid="${gwyjbList.NId}" data-fydm="${gwyjbList.NFy}" data-rybh="${gwyjbList.NRybh}"> 
...
<div id="gwyjb_dlg"></div><div class="J_dlg"></div>
</body>
</html>
