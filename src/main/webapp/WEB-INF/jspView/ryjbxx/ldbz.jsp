	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;领导班子</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="ldbz_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="ldbz_list" class="main_list">
									<table class="dataTable"  data-maxindex="${ldbzList.size()}">
										<thead>
										...
										<tbody>
											<c:forEach items="${ldbzList}" var="ldbzList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${ldbzList.CQgzdw}</td>
														<td class="center">${ldbzList.CQgzbm}</td>
														<td class="center">${ldbzList.NZw}</td>
														<td class="center">${ldbzList.NCjkc}</td>
														<td class="center" data-keyid="${ldbzList.NId}" data-fydm="${ldbzList.NFy}" data-rybh="${ldbzList.NRybh}"> 
...
<div id="ldbz_dlg"></div><div class="J_dlg"></div>
</body>
</html>
