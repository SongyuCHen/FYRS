	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;培训信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="pxxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
								<div id="pxxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${pxxxList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="65px" style="text-align:left">培训形式</th>
											<th width="130px">培训班名称</th>
										...
										<tbody>
											<c:forEach items="${pxxxList}" var="pxxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${pxxxList.NPxxs}</td>
														<td class="center">${pxxxList.CPxbmc}</td>
														<td class="center">${pxxxList.DKsrq}</td>
														<td class="center">${pxxxList.DJsrq}</td>
														<td class="center">${pxxxList.NZy}</td>
														<td class="center" data-keyid="${pxxxList.NId}" data-fydm="${pxxxList.NFy}" data-rybh="${pxxxList.NRybh}"> 
...
<div id="pxxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
