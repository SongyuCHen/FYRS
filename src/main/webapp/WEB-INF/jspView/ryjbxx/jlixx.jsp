	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;奖励信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="jlixx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="jianglxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${jlixxList.size()}">
										<thead>
											<th width="43px" style="text-align:left">序号</th>
											<th>奖励类型</th>
											<th>奖励原因</th>
											<th width="80px">个人情况</th>
											<th width="80px">奖励级别</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${jlixxList}" var="jlixxList"
													varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${jlixxList.NJllb}</td>
														<td class="center">${jlixxList.NJlyy}</td>
														<td class="center">${jlixxList.NGrqk}</td>
														<td class="center">${jlixxList.NJljb}</td>
														<td class="center" data-keyid="${jlixxList.NId}" data-fydm="${jlixxList.NFy}" data-rybh="${jlixxList.NRybh}"> 
...
<div id="jlixx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
