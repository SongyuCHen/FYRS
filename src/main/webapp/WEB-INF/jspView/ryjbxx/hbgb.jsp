	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;后备干部</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="hbgb_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="hbgb_list" class="main_list">
									<table class="dataTable" data-maxindex="${hbgbList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">后备职务</th>
											<th>锻炼职务</th>
											<th>锻炼单位</th>
										...
										<tbody>
											<c:forEach items="${hbgbList}" var="hbgbList"
													varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${hbgbList.NHbzw}</td>
														<td class="center">${hbgbList.NDlzw}</td>
														<td class="center">${hbgbList.CDldw}</td>
														<td class="center">${hbgbList.DKssj}</td>
														<td class="center">${hbgbList.DJssj}</td>
														<td class="center" data-keyid="${hbgbList.NId}" data-fydm="${hbgbList.NFy}" data-rybh="${hbgbList.NRybh}"> 
...
<div id="hbgb_dlg"></div><div class="J_dlg"></div>
</body>
</html>
