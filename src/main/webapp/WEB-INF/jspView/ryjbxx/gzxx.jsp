	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;工资信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="gzxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="gzxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${gzxxList.size()}">
										<thead>
										...
										<tbody>
											<c:forEach items="${gzxxList}" var="gzxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1 }</td>
														<td class="center">${gzxxList.CZwgzdc }</td>
														<td class="center">${gzxxList.DZwgzdcsj }</td>
														<td class="center">${gzxxList.MZwgze }</td>
														<td class="center">${gzxxList.MJbgze }</td>
														<td class="center" data-keyid="${gzxxList.NId}" data-fydm="${gzxxList.NFy}" data-rybh="${gzxxList.NRybh}"> 
...
<div id="gzxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
