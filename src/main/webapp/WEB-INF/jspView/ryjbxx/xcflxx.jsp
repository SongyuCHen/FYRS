	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;数据变动信息&nbsp;&gt;薪酬福利信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="xcflxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="xcflxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${fljlList.size()}">
										<thead>
										...
										<tbody>
												<c:forEach items="${fljlList}" var="fljlList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${fljlList.DFfsj}</td>
														<td class="center">${fljlList.MJbxc}</td>
														<td class="center">${fljlList.MFlbt}</td>
														<td class="center">${fljlList.NKq}</td>
														<td class="center">${fljlList.CBz}</td>
														<td class="center" data-keyid="${fljlList.NId}" data-fydm="${fljlList.NFy}" data-rybh="${fljlList.NRybh}"> 
...
<div id="xcflxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
