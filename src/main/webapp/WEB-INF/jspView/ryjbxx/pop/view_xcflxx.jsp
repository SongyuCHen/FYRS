...
<table id="xcflxx_table" data-keyid="${fljl.NId}" data-fydm="${fljl.NFy}"
	data-rybh="${fljl.NRybh}">
	<tr style="height:35px">
		<td class="odd_td" style="font-weight:bold;">发放时间：</td>
		<td class="even_td"><input type="text" id="checkDate1" class="myDate_label" value="${fljl.DFfsj}" /></td>
		<td class="odd_td" style="font-weight:bold;">基本薪酬：</td>
		<td class="even_td"><input type="text" class="myLabel" value="${fljl.MJbxc}" /></td>
	</tr>
	<tr style="height:35px">
		<td class="odd_td">福利补贴：</td>
		<td class="even_td"><input type="text" class="myLabel" value="${fljl.MFlbt}" /></td>
		<td class="odd_td">考勤：</td>
		<td class="even_td"><input type="text" class="myLabel" value="${fljl.NKq}" /></td>
	</tr>
	<tr>
		<td class="odd_td">备注：</td>
		<td class="even_td"><input type="text" class="myLabel" value="${fljl.CBz}" /></td>
	</tr>
</table>
