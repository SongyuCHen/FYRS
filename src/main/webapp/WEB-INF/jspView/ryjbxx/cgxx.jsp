	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;出国信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="cgxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="cgxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${cgxxList.size()}">
										<thead>
										...
										<tbody>
											<c:forEach items="${cgxxList}" var="cgxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${cgxxList.NGb}</td>
														<td class="center">${cgxxList.NCgxz}</td>
														<td class="center">${cgxxList.DKssj}</td>
														<td class="center">${cgxxList.DJssj}</td>
														<td class="center" data-keyid="${cgxxList.NId}" data-fydm="${cgxxList.NFy}" data-rybh="${cgxxList.NRybh}"> 
...
<div id="cgxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
