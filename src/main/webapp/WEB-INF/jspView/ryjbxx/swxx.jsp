	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;伤亡信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="swxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="swxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${swxxList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th>伤亡程度</th>
											<th>伤亡原因</th>
											<th width="80px">伤亡日期</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${swxxList}" var="swxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${swxxList.NSwcd}</td>
														<td class="center">${swxxList.NSwyy}</td>
														<td class="center">${swxxList.DSwrq}</td>
														<td class="center" data-keyid="${swxxList.NId}" data-fydm="${swxxList.NFy}" data-rybh="${swxxList.NRybh}"> 
...
<div id="swxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
