	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;数据变动信息&nbsp;&gt;社保记录</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="sbjl_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="sbjl_list" class="main_list">
									<table class="dataTable" data-maxindex="${shebaoList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">险种类型</th>
											<th>开始时间</th>
											<th>结束时间</th>
											<th width="90px">个人应缴</th>
											<th>单位应缴</th>
											<th>缴费合计</th>
											<th>操作</th>
										</thead>
										<tbody>
												<c:forEach items="${shebaoList}" var="shebaoList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${shebaoList.NType}</td>
														<td class="center">${shebaoList.DKssj}</td>
														<td class="center">${shebaoList.DJssj}</td>
														<td class="center">${shebaoList.MGryj}</td>
														<td class="center">${shebaoList.MDwyj}</td>
														<td class="center">${shebaoList.MFyhj}</td>
														<td class="center" data-keyid="${shebaoList.NId}" data-fydm="${shebaoList.NFy}" data-rybh="${shebaoList.NRybh}"> 
...
<div id="sbjl_dlg"></div><div class="J_dlg"></div>
</body>
</html>
