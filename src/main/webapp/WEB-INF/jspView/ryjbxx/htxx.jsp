...
<div class="wapper">
	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;合同信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="htxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="htxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${htxxList.size()}">
										<thead>
											<th width="42px">序号</th>
											<th width="80px">合同编号</th>
											<th>签订时间</th>
											<th width="90px">合同期限</th>
											<th width="90px">聘任职位</th>
											<th>备注</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${htxxList}" var="htxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${htxxList.CHtbh}</td>
														<td class="center">${htxxList.DQdrq}</td>
														<td class="center">${htxxList.CHtqx}</td>
														<td class="center">${htxxList.CPrzw}</td>
														<td class="center">${htxxList.CBz}</td>
														<td class="center" data-keyid="${htxxList.NId}" data-fydm="${htxxList.NFy}" data-rybh="${htxxList.NRybh}"> 
 ...
 <div id="htxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
