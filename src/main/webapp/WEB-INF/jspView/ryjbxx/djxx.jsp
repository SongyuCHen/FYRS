...
<body>
<div id="top_left"></div><div class="wapper">
	<div class="header">
	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;等级信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="djxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="djxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${djxxList.size()}">
										<thead>
											<th width="42px">序号</th>
											<th width="80px">等级类别</th>
											<th>等级名称</th>
											<th width="90px">起算日期</th>
											<th width="90px">证书编号</th>
											<th>当前信息</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${djxxList}" var="djxxList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${djxxList.NDjlb}</td>
														<td class="center">${djxxList.NDjmc}</td>
														<td class="center">${djxxList.DQsrq}</td>
														<td class="center">${djxxList.CZsbh}</td>
														<td class="center">${djxxList.NDqxx}</td>
														<td class="center" data-keyid="${djxxList.NId}" data-fydm="${djxxList.NFy}" data-rybh="${djxxList.NRybh}"> 
 ...
 <div id="djxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
