	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;考核信息</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="khxx_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="khxx_list" class="main_list">
									<table class="dataTable" data-maxindex="${khxxList.size()}">
										<thead>
											<th>序号</th>
											<th>年度</th>
											<th>考核结果</th>
										...
										<tbody>
											<c:forEach items="${khxxList}" var="khxxList"
													varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${khxxList.NNd}</td>
														<td class="center">${khxxList.NKhjg}</td>
														<td class="center" data-keyid="${khxxList.NId}" data-fydm="${khxxList.NFy}" data-rybh="${khxxList.NRybh}"> 
...
<div id="khxx_dlg"></div><div class="J_dlg"></div>
</body>
</html>
