	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;法律职务</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="flzw_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>  
								</div>
									<div id="flzw_list" class="main_list">
									<table class="dataTable"  data-maxindex="${flzwList.size()}">
										<thead>
										...
										<tbody>
											<c:forEach items="${flzwList}" var="flzwlist" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${flzwlist.NRmlb}</td>
														<td class="center">${flzwlist.CDw}</td>
														<td class="center">${flzwlist.NFlzw}</td>
														<td class="center">${flzwlist.DRmrq}</td>
														<td class="center">${flzwlist.DPzrq}</td>
														<td class="center">${flzwlist.NDqxx}</td>
														<td class="center" data-keyid="${flzwlist.NId}" data-fydm="${flzwlist.NFy}" data-rybh="${flzwlist.NRybh}"> 
...
<div id="flzw_dlg"></div><div class="J_dlg"></div>
</body>
</html>
