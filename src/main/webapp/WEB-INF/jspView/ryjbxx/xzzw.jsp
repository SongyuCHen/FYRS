	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;人员信息&nbsp;&gt;行政职务</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="xzzw_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
								<div id="xzzw_list" class="main_list">
									<table class="dataTable" data-maxindex="${xzzwList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="60px" style="text-align:left">任免类型</th>
											<th width="80px">单位</th>
											<th width="80px">行政职务</th>
											<th width="76px">任免日期</th>
											<th width="76px">批准日期</th>
											<th width="76px">当前信息</th>
											<th>操作</th>
										</thead>
										<tbody>
											<c:forEach items="${xzzwList}" var="xzzwList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${xzzwList.NRmlb}</td>
														<td class="center">${xzzwList.CDw}</td>
														<td class="center">${xzzwList.NXzzw}</td>
														<td class="center">${xzzwList.DRmrq}</td>
														<td class="center">${xzzwList.DPzrq}</td>
														<td class="center">${xzzwList.NDqxx}</td>
														<td class="center" data-keyid="${xzzwList.NId}" data-fydm="${xzzwList.NFy}" data-rybh="${xzzwList.NRybh}"> 
...
<div id="xzzw_dlg"></div><div class="J_dlg"></div>
</body>
</html>
