	...
	<div class="main_contain">
		...
		<div class="main">
			...
			<div class="right_content">
				<div id="current_position"><span id="position_text">当前位置：&nbsp;数据变动信息&nbsp;&gt;在岗情况</span>
				</div>
						...
						<div id="detail">
							<div class="main_wapper">
								<div class="wapper_title">
									...
									<button type="button" class="btn btn-primary" id="zgqk_add_btn" data-btn_type="0" <c:if test="${isHidden}">style="visibility:hidden;"</c:if>>
										<span class="glyphicon glyphicon-plus"></span> 添加
									</button>
								</div>
									<div id="zgqk_list" class="main_list">
									<table class="dataTable" data-maxindex="${zgqkList.size()}">
										<thead>
											<th width="42px" style="text-align:left">序号</th>
											<th width="80px">批准文号</th>
											<th>变动时间</th>
											<th>变动前部门</th>
											<th width="90px">变动后部门</th>
											<th>备注</th>
											<th>操作</th>
										</thead>
										<tbody>
												<c:forEach items="${zgqkList}" var="zgqkList" varStatus="i">
													<tr>
														<td class="center">${i.index+1}</td>
														<td class="center">${zgqkList.CPzwh}</td>
														<td class="center">${zgqkList.DBgsj}</td>
														<td class="center">${zgqkList.CBmbefore}</td>
														<td class="center">${zgqkList.CBmafter}</td>
														<td class="center">${zgqkList.CBz}</td>
														<td class="center" data-keyid="${zgqkList.NId}" data-fydm="${zgqkList.NFy}" data-rybh="${zgqkList.NRybh}"> 
...
<div id="zgqk_dlg"></div><div class="J_dlg"></div>
</body>
</html>
