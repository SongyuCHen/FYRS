...
<html>
  ...
  <body>
	...
	<div id="printdiv">
		<div class="bt">${bt}</div>
		<div class="xbt">中层干部（${zcgbs.size() }人）</div>
		<table align="center">
			<tr>
				<td>姓名</td>
				<td>出生日期</td>
			...
			<c:forEach items="${zcgbs}" var="item" varStatus="status">
				<tr>
					<td>${item.name }</td>
					<td>${item.csrq }</td>
					<td>${item.xzzw }</td>
		...
		<br>
		<div class="xbt">1、正职（${zzs.size() }人）</div>
		<table align="center">
			<tr>
				<td>姓名</td>
				<td>出生日期</td>
			...
			<c:forEach items="${zzs}" var="item" varStatus="status">
				<tr>
					<td>${item.name }</td>
					<td>${item.csrq }</td>
					<td>${item.xzzw }</td>
		...
		<br>
		<div class="xbt">2、副职（${fzs.size() }人）</div>
		<table align="center">
			<tr>
				<td>姓名</td>
				<td>出生日期</td>
			...
			<c:forEach items="${fzs}" var="item" varStatus="status">
				<tr>
					<td>${item.name }</td>
					<td>${item.csrq }</td>
					<td>${item.xzzw }</td>
		...
		<br>
		<div class="xbt">3、专职书记、副书记（${sjs.size() }人）</div>
		<table align="center">
			<tr>
				<td>姓名</td>
				<td>出生日期</td>
			...
			<c:forEach items="${sjs}" var="item" varStatus="status">
				<tr>
					<td>${item.name }</td>
					<td>${item.csrq }</td>
					<td>${item.xzzw }</td>
