...
<html>
  ...
  <body>
	...
	<div id="printdiv">
		<div class="bt">${bt}</div>
		<div class="xbt">1、处级干部（${cjs.size() }人）</div>
		<table align="center">
			<tr>
				<td>部门</td>
				<td>姓名</td>
			...
			<c:forEach items="${cjs}" var="item" varStatus="status">
				<tr>
					<td>${item.bm }</td>
					<td>${item.name }</td>
					<td>${item.csrq }</td>
		...
		<br>
		<div class="xbt">2、科级干部（${kjs.size() }人）</div>
		<table align="center">
			<tr>
				<td>部门</td>
				<td>姓名</td>
			...
			<c:forEach items="${kjs}" var="item" varStatus="status">
				<tr>
					<td>${item.bm }</td>
					<td>${item.name }</td>
					<td>${item.csrq }</td>
		...
		<br>
		<div class="xbt">3、科员（${kys.size() }人）</div>
		<table align="center">
			<tr>
				<td>部门</td>
				<td>姓名</td>
