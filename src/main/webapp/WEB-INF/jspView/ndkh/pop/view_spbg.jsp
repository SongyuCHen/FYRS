					...
					if ($("#xs").is(":hidden")) {
						$.ajax({
							...
							success : function(json) {
								$roles_oTable.fnClearTable();
								$roles_oTable.fnDestroy();
								initTable("spbglist");
...
<div id="titleContent" class="form-horizontal">
	<div class="row">
		...
		<div class="col-sm-5 col-md-5" id="xs" data-sfxs=${gbcsp} style="display:inline-block;">
...
<div id="spbglist" class="main_list">
