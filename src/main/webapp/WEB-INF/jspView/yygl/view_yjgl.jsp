...
<table id="yjgl_table" data-keyid="${yjgl.NId}" data-fydm="${yjgl.NFy}"
	data-rybh="${yjgl.NRybh}">
	<tr style="height:35px">
		...
		<%-- <td class="even_td"><input type="text" class="myLabel" value="${yjgl.CXm}" /></td> --%>
	</tr>
	<tr style="height:35px">
	<td class="odd_td">预警事项：</td>
		<td class="even_td"><input type="text" class="myLabel" value="${yjgl.CYjsx}" /></td>
		<td class="odd_td" >预警时间：</td>
		<td class="even_td"><input type="text" id="checkDate1" class="myDate_label" value="${yjgl.DYjsj}" /></td>		
	</tr>
	<tr>
		<td class="odd_td">备注：</td>
		<td class="even_td"><input type="text" class="myLabel" value="${yjgl.CBz}" /></td>
	</tr>
</table>
