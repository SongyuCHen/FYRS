...
<table id="gzgl_table" data-keyid="${gzgl.NId}" data-fydm="${gzgl.NFy}"
	data-rybh="${gzgl.NRybh}">
	<tr style="height:35px">
		...
		<!-- <input type="text" class="myLabel" id="xmxz" value="${gzgl.CXm}" /></td>-->
	</tr>
	<tr style="height:35px">
		<td class="odd_td" >发放时间：</td>
		<td class="even_td"><input type="text" id="checkDate1" class="myDate_label" value="${gzgl.DFfsj}" /></td>
		<td class="odd_td">基本薪酬：</td>
		<td class="even_td"><input type="text" class="myLabel" value="${gzgl.MJbxc}" /></td>
	</tr>
	<tr style="height:35px">
		<td class="odd_td">福利补贴：</td>
		<td class="even_td"><input type="text" class="myLabel" value="${gzgl.MFlbt}" /></td>
		<td class="odd_td">考勤：</td>
		<td class="even_td"><input type="text" class="myLabel" value="${gzgl.NKq}" /></td>
	</tr>
	<tr>
		<td class="odd_td">备注：</td>
		<td class="even_td"><input type="text" class="myLabel" value="${gzgl.CBz}" /></td>
	</tr>
</table>
