					  ...
					  for(var i = 0; i < json.length; i++)
						  {
						    ...
						    html += '<td class="center">'+rywhlog.CCzyh+'</td>';
						    html += '<td class="center">'+rywhlog.DCzsj+'</td>';
						    html += '<td class="center">'+rywhlog.CCznr+'</td>';
						    html += '<td class="center">'+rywhlog.CIp+'</td>';
						    html += "</tr>";
						  }
					  html += '</tbody></table>';
					  // $("#qxgl_list #dataTable").remove();
					  $("#xxxgrz_list  #dataTable_wrapper").remove();
					  $("#xxxgrz_list").append(html);
					  initTable("xxxgrz_list");
				  }
...
<body>
	<div id="xxxgrz-head" class="form-horizontal">
			<div class="form-group" >
			    <label  for="operUser" style="display:inline-block;width:100px;height:24px;text-align:center;">操作用户：</label>
			    ...
			    <label  for="operBeginTime" style="display:inline-block;width:90px;height:24px;text-align:center;">操作时间：</label>
    		...
    		<div class="form-group">
    			...
    			<div style="display:inline-block;float:right;margin-right:80px;">
					<button type="button" class="btn btn-primary" id="find_btn" style="display:inline-block;">
						<span class="glyphicon glyphicon-search"></span> 查询
					</button>	
				</div>
    		</div>
	</div>
	<div id="xxxgrz_list" class="main_list">
		<table id="dataTable" class="dataTable" cellspacing="0" width="100%">
			<thead>
				<tr class="tableHead">
					<th width="60px">序号</th>
					<th width="140px">操作用户</th>
