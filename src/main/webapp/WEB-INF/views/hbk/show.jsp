		...
		$
				.ajax({
					...
					success : function(str) {
						...
						var html = '<table id="dataTable" class="cell-border" cellspacing="0" width="100%"><thead><tr class="tableHead"><th></th><th>序号</th><th>姓名</th><th>性别</th><th>年龄</th><th>毕业院校</th><th>学历</th><th>报表</th><th>操作</th></tr></thead><tbody>';
						for ( var i = 0; i < json.length; i++) {
							...
							if (!ryjbxx.isOnlyLook) {
								html += '<td class="center operations"  data-showKey="'+ryjbxx.showKey+'" data-isOnlyLook="'+ryjbxx.isOnlyLookEncode+'"  data-fydm="'+ryjbxx.fy+'" data-rybh="'+ryjbxx.rybh+'"><a class="ry_modify hbkxg" href="javascript:void(0);">查看</a><span>|</span> <a class="ry_modify hbksc" href="javascript:void(0);">入职</a></td><span>|</span> <a class="ry_delete hbksc" href="javascript:void(0);">删除</a></td>';
							} else {
								html += '<td class="center operations"  data-showKey="'+ryjbxx.showKey+'" data-isOnlyLook="'+ryjbxx.isOnlyLookEncode+'"  data-fydm="'+ryjbxx.fy+'" data-rybh="'+ryjbxx.rybh+'"><a class="ry_modify hbkxg" href="javascript:void(0);">查看</a></td>';
							}
							html += "</tr>";
						}
						html += '</tbody></table>';
						// $("#qxgl_list #dataTable").remove();
						$("#hbk_list  #dataTable_wrapper").remove();
						$("#hbk_list").append(html);
						initTable("hbk_list");
...
<body>
	...
	<div class="operation btn-group">
		<button type="button" class="btn btn-primary btn-sm" id="hbktj">
			<span class="glyphicon glyphicon-plus"></span> 添加
		</button>
		<button type="button" class="btn btn-primary btn-sm" id="hbkyr">
		...
		<button type="button" class="btn btn-primary btn-sm" id="hbkplxg">
			<span class="glyphicon glyphicon-refresh"></span> 批量修改
		</button>
		<button type="button" class="btn btn-primary btn-sm" id="hbkrz">
			<span class="glyphicon glyphicon-plus"></span> 入职
		</button>
		<button type="button" class="btn btn-primary btn-sm" id="hbksy">
			<span class="glyphicon glyphicon-arrow-up"></span> 上移
		</button>
		<button type="button" class="btn btn-primary btn-sm" id="hbkxy">
			<span class="glyphicon glyphicon-arrow-down"></span> 下移
		</button>
	</div>
	<img src="/resources/images/loading.gif" id="loadingSpinner"
		style="display:none;" />
	<div id="hbk_list" class="main_list" width="80%">
