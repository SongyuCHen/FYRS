...
<head>
   ...
   <script type="text/javascript">
     ...
     var initDataTable = function(fydm){
		 $.ajax({
	    	  url:"/main/kqgl/kqglDetail.aj",
	    	  type:"POST",
	    	  data:{fydm:fydm},
	    	  dataType:"json",
	    	  success:function(json){
	    		  var html = '<table id="dataTable" class="cell-border" cellspacing="0" width="100%"><thead><tr class="tableHead"><tr><th width="150px">编号</th><th width="150px">姓名</th><th width="80px">部门</th><th>考勤日期</th><th>考勤事项</th><th>备注</th><th width="100px">操作</th></tr></thead><tbody>';
				  ...
				  html += '</tbody></table>';
				  $("#kqgl_list  #dataTable_wrapper").remove();
				  $("#kqgl_list").append(html);
				  initTable("kqgl_list");
	    	  }
	      }); 
	 };
...
<body>
 <div id="kqgl_xzfy" class="form-horizontal">
 ...
 <div class="operationDiv clearfix">
 	<button type="button" class="btn btn-primary" id="kqgl_add" data-btnType="0">
		<span class="glyphicon glyphicon-plus"></span> 添加
	</button>
	<button type="button" class="btn btn-primary" id="kqgl_add" data-btnType="0">
		<span class="glyphicon glyphicon-plus"></span> 定义假期
	</button>
 </div>
	<div id="kqgl_list">
