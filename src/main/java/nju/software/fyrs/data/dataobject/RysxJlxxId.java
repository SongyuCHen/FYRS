...
/**
 * RysxJlxxId entity. @author MyEclipse Persistence Tools
 */
public class RysxJlxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7383666908557261642L;
	...
	/** full constructor */
	public RysxJlxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxJlxxId))
			return false;
		RysxJlxxId castOther = (RysxJlxxId) other;
