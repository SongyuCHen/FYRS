...
/**
 * RysxFlzw entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_RYSX_FLZW")
@IdClass(RysxFlzwId.class)
public class RysxFlzw implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6873793218115772898L;
	...
	private Short NCrfg;
	private Short NCrfgnx;
	private Long NFlgzqk;
	private Short NFlzyzs;
	private Long NFlzyzsqk;
	private Short NDqxx;
	 ...
	 * @param nXssx
	 */
	public RysxFlzw(BigDecimal nId, Integer nFy, Integer nRybh, Integer nRmlb, Integer nFlzw, Date dRmrq, String cDw, String cBm, Integer nRmyy, Date dPzrq, String cPzdw, String cPzwh,
			Short nCrfg, Short nCrfgnx, Long nFlgzqk, Short nFlzyzs, Long nFlzyzsqk, Short nDqxx, String cJlid, Integer nXssx)
	{
		super();
		NId = nId;
		NFy = nFy;
	...
	@Column(name = "N_CRFG")
	public Short getNCrfg()
	{
		return this.NCrfg;
	}

	public void setNCrfg(Short NCrfg)
	{
		this.NCrfg = NCrfg;
	}

	@Column(name = "N_CRFGNX")
	public Short getNCrfgnx()
	{
		return this.NCrfgnx;
	}

	public void setNCrfgnx(Short NCrfgnx)
	{
		this.NCrfgnx = NCrfgnx;
	}

	@Column(name = "N_FLGZQK", precision = 15, scale = 0)
	public Long getNFlgzqk()
	{
		return this.NFlgzqk;
	}

	public void setNFlgzqk(Long NFlgzqk)
	{
		this.NFlgzqk = NFlgzqk;
	}

	@Column(name = "N_FLZYZS")
	public Short getNFlzyzs()
	{
		return this.NFlzyzs;
	}

	public void setNFlzyzs(Short NFlzyzs)
	{
		this.NFlzyzs = NFlzyzs;
	}

	@Column(name = "N_FLZYZSQK", precision = 15, scale = 0)
	public Long getNFlzyzsqk()
	{
		return this.NFlzyzsqk;
	}

	public void setNFlzyzsqk(Long NFlzyzsqk)
	{
		this.NFlzyzsqk = NFlzyzsqk;
	}
