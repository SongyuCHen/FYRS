...
/**
 * RysxGzxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxGzxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1385064833985163134L;
	...
	/** full constructor */
	public RysxGzxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxGzxxId))
			return false;
		RysxGzxxId castOther = (RysxGzxxId) other;
