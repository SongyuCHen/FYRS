...
/**
 * RysxCgxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxCgxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3417290233940542257L;
	...
	/** full constructor */
	public RysxCgxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxCgxxId))
			return false;
		RysxCgxxId castOther = (RysxCgxxId) other;
