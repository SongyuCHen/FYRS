 ...
 */
@Embeddable
public class RysxJialliuxxId implements java.io.Serializable {
	...
	/** default constructor */
	public RysxJialliuxxId()
	{
	}

	/** full constructor */
	public RysxJialliuxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxJialliuxxId))
			return false;
		RysxJialliuxxId castOther = (RysxJialliuxxId) other;
