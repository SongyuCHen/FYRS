...
/**
 * RysxTxlId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxTxlId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8245402715386877088L;
	...
	/** full constructor */
	public RysxTxlId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxTxlId))
			return false;
		RysxTxlId castOther = (RysxTxlId) other;
