 ...
 */
@Entity
@Table(name = "T_RYSX_JLXX")
@IdClass(RysxJlxxId.class)
public class RysxJlxx implements java.io.Serializable {
	...
	/** full constructor */
	public RysxJlxx(BigDecimal NId, Integer NFy, Integer NRybh, String CSzdw, String CSzbm, Date DQsrq, Date DJzrq, String CZw, String CZj, String CZmr, String CGlxx, Integer NXssx)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
