...
/**
 * RysxSyyyxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxSyyyxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3872697284237460905L;
	...
	/** full constructor */
	public RysxSyyyxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxSyyyxId))
			return false;
		RysxSyyyxId castOther = (RysxSyyyxId) other;
