...
/**
 * RysxFlzwId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxFlzwId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8169357874207681843L;
	...
	/** full constructor */
	public RysxFlzwId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxFlzwId))
			return false;
		RysxFlzwId castOther = (RysxFlzwId) other;
