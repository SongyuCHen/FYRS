...
/**
 * RysxCcxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxCcxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8541705107616446075L;
	...
	/** full constructor */
	public RysxCcxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxCcxxId))
			return false;
		RysxCcxxId castOther = (RysxCcxxId) other;
