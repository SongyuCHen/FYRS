...
/**
 * RysxGwyId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxGwyId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2461841542249525487L;
	...
	/** full constructor */
	public RysxGwyId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxGwyId))
			return false;
		RysxGwyId castOther = (RysxGwyId) other;
