 ...
 */
public class FzbJlxxId implements java.io.Serializable {
	...
	/** full constructor */
	public FzbJlxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof FzbJlxxId))
			return false;
		FzbJlxxId castOther = (FzbJlxxId) other;
