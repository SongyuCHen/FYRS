...
/**
 * RysxZyjszwId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxZyjszwId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3046121747424787589L;
	...
	/** full constructor */
	public RysxZyjszwId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxZyjszwId))
			return false;
		RysxZyjszwId castOther = (RysxZyjszwId) other;
