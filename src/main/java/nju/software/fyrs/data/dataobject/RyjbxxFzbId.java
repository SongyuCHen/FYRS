...
/**
 * RyjbxxId entity. @author MyEclipse Persistence Tools
 */
public class RyjbxxFzbId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2673792382853698905L;
	/**
	 * 
	 */
	private Integer NFy;
	...
	/** full constructor */
	public RyjbxxFzbId(Integer NFy, Integer NRybh)
	{
		this.NFy = NFy;
		this.NRybh = NRybh;
	}
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RyjbxxId))
			return false;
		RyjbxxId castOther = (RyjbxxId) other;
