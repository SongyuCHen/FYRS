 ...
 */
@Entity
@Table(name = "T_RYSX_PHOTO")
@IdClass(RysxPhotoId.class)
public class RysxPhoto implements java.io.Serializable {
	 ...
	 * @param iPhoto
	 */
	public RysxPhoto(Integer nFy, Integer nRybh, byte[] iPhoto)
	{
		super();
		NFy = nFy;
		NRybh = nRybh;
