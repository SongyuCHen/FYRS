...
/**
 * RysxSwxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxSwxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3206720629754756711L;
	...
	/** full constructor */
	public RysxSwxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxSwxxId))
			return false;
		RysxSwxxId castOther = (RysxSwxxId) other;
