...
/**
 * RysxJtxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxJtxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7714394126151918852L;
	...
	/** full constructor */
	public RysxJtxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxJtxxId))
			return false;
		RysxJtxxId castOther = (RysxJtxxId) other;
