...
/**
 * RysxPxxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxPxxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8811218291245251464L;
	...
	/** full constructor */
	public RysxPxxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxPxxxId))
			return false;
		RysxPxxxId castOther = (RysxPxxxId) other;
