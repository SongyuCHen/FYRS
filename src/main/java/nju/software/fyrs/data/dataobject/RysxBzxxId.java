...
/**
 * RysxBzxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxBzxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4567708795985558140L;
	...
	/** full constructor */
	public RysxBzxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxBzxxId))
			return false;
		RysxBzxxId castOther = (RysxBzxxId) other;
