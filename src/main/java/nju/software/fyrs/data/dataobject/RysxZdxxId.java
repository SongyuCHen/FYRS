...
/**
 * RysxZdxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxZdxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6558351350657941972L;
	...
	/** full constructor */
	public RysxZdxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxZdxxId))
			return false;
		RysxZdxxId castOther = (RysxZdxxId) other;
