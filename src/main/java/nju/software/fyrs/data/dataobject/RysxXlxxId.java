...
/**
 * RysxXlxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxXlxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1985543884122185334L;
	...
	/** full constructor */
	public RysxXlxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxXlxxId))
			return false;
		RysxXlxxId castOther = (RysxXlxxId) other;
