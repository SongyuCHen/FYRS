...
/**
 * RysxJzzwId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxJzzwId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5586554921029708426L;
	...
	/** full constructor */
	public RysxJzzwId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxJzzwId))
			return false;
		RysxJzzwId castOther = (RysxJzzwId) other;
