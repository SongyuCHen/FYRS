...
/**
 * RysxXzzwId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxXzzwId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6960217582498683267L;
	...
	/** full constructor */
	public RysxXzzwId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxXzzwId))
			return false;
		RysxXzzwId castOther = (RysxXzzwId) other;
