...
/**
 * RysxHbgbId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxHbgbId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8465610042253560069L;
	...
	/** full constructor */
	public RysxHbgbId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxHbgbId))
			return false;
		RysxHbgbId castOther = (RysxHbgbId) other;
