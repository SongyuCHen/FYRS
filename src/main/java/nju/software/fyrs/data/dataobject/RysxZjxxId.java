...
/**
 * RysxZjxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxZjxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7420107940747794374L;
	...
	/** full constructor */
	public RysxZjxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxZjxxId))
			return false;
		RysxZjxxId castOther = (RysxZjxxId) other;
