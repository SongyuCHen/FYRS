...
/**
 * RysxDjxxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxDjxxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4846139283324160474L;
	...
	/** full constructor */
	public RysxDjxxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxDjxxId))
			return false;
		RysxDjxxId castOther = (RysxDjxxId) other;
