...
/**
 * RysxJianglixxId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class RysxJianglixxId implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7306002244553160683L;
	...
	/** default constructor */
	public RysxJianglixxId()
	{
	}

	/** full constructor */
	public RysxJianglixxId(BigDecimal NId, Integer NFy, Integer NRybh)
	{
		this.NId = NId;
		this.NFy = NFy;
		this.NRybh = NRybh;
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof RysxJianglixxId))
			return false;
		RysxJianglixxId castOther = (RysxJianglixxId) other;
