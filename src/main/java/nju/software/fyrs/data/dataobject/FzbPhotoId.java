...
public class FzbPhotoId implements java.io.Serializable {
	...
	/** full constructor */
	public FzbPhotoId(Integer NFy, Integer NRybh)
	{
		this.NFy = NFy;
		this.NRybh = NRybh;
	}
	...
	public boolean equals(Object other)
	{
		...
		if ((other == null))
			return false;
		if (!(other instanceof FzbPhotoId))
			return false;
		FzbPhotoId castOther = (FzbPhotoId) other;
