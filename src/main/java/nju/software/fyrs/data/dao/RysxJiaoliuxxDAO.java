...
/**
 	* A data access object (DAO) providing persistence and search support for RysxJiaoliuxx entities.
 ...
 */
public class RysxJiaoliuxxDAO extends HibernateDaoSupport  {
	     private static final Logger log = LoggerFactory.getLogger(RysxJiaoliuxxDAO.class);
		//property constants
    ...
    public void save(RysxJiaoliuxx transientInstance) {
        log.debug("saving RysxJiaoliuxx instance");
        try {
	...
	public void delete(RysxJiaoliuxx persistentInstance) {
        log.debug("deleting RysxJiaoliuxx instance");
        try {
    ...
    public RysxJiaoliuxx findById( nju.software.fyrs.data.dataobject.RysxJiaoliuxxId id) {
        log.debug("getting RysxJiaoliuxx instance with id: " + id);
        try {
            RysxJiaoliuxx instance = (RysxJiaoliuxx) getHibernateTemplate()
                    .get("software.fyrs.data.RysxJiaoliuxx", id);
            return instance;
        } catch (RuntimeException re) {
	...
	public List<RysxJiaoliuxx> findByExample(RysxJiaoliuxx instance) {
        log.debug("finding RysxJiaoliuxx instance by example");
        try {
	...
	public List findByProperty(String propertyName, Object value) {
      log.debug("finding RysxJiaoliuxx instance with property: " + propertyName
            + ", value: " + value);
      try {
         String queryString = "from RysxJiaoliuxx as model where model." 
         						+ propertyName + "= ?";
	...
	@SuppressWarnings("rawtypes")
	public List findAll() {
		log.debug("finding all RysxJiaoliuxx instances");
		try {
			String queryString = "from RysxJiaoliuxx";
    ...
    public RysxJiaoliuxx merge(RysxJiaoliuxx detachedInstance) {
        log.debug("merging RysxJiaoliuxx instance");
        try {
    ...
    public void attachDirty(RysxJiaoliuxx instance) {
        log.debug("attaching dirty RysxJiaoliuxx instance");
        try {
    ...
    public void attachClean(RysxJiaoliuxx instance) {
        log.debug("attaching clean RysxJiaoliuxx instance");
        try {
	...
	public static RysxJiaoliuxxDAO getFromApplicationContext(ApplicationContext ctx) {
    	return (RysxJiaoliuxxDAO) ctx.getBean("RysxJiaoliuxxDAO");
	}
	
	@SuppressWarnings("unchecked")
	public List<RysxJiaoliuxx> getJliuxxByRybh(String rybh){
		int nrybh = Integer.parseInt(rybh);
		String hql = "from RysxJiaoliuxx where NRybh=?";
	...
	public boolean delRsJliuxxById(String rybh,String bh){
		...
		String hql = "from RysxJiaoliuxx where NRybh=? and NId=?";
