...
import nju.software.fyrs.data.dataobject.TableDO;
 ...
 * 
 * @see nju.software.fyrs.data.dataobject.TableDO
...
public class TableDAO extends HibernateDaoSupport {
	...
	public void save(TableDO transientInstance) {
	...
	public void delete(TableDO persistentInstance) {
	...
	public TableDO findById(java.lang.String id) {
		log.debug("getting Table instance with id: " + id);
		try {
			TableDO instance = (TableDO) getHibernateTemplate().get(
					"software.fyrs.data.Table", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<TableDO> findByExample(TableDO instance) {
		log.debug("finding Table instance by example");
		try {
			List<TableDO> results = (List<TableDO>) getHibernateTemplate()
	...
	@SuppressWarnings("unchecked")
	public List<TableDO> findByCCnname(Object CCnname) {
	...
	public TableDO merge(TableDO detachedInstance) {
		log.debug("merging Table instance");
		try {
			TableDO result = (TableDO) getHibernateTemplate().merge(
					detachedInstance);
	...
	public void attachDirty(TableDO instance) {
	...
	public void attachClean(TableDO instance) {
